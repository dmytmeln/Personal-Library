...
public class SortableFields {
    ...
    public static final Set<String> BOOK_FIELDS = Set.of(ID_FIELD, TITLE_FIELD, PUBLISH_YEAR_FIELD, LANGUAGE_FIELD, PAGES_FIELD,
            CATEGORY_ID_FIELD, CATEGORY_NAME_FIELD, POPULARITY_COUNT_FIELD);

    public static final Set<String> AUTHOR_FIELDS = Set.of(ID_FIELD, FULL_NAME_FIELD, COUNTRY_FIELD, BIRTH_YEAR_FIELD, DEATH_YEAR_FIELD,
            BOOKS_COUNT_FIELD, POPULARITY_COUNT_FIELD);

    public static final Set<String> CATEGORY_FIELDS = Set.of(ID_FIELD, NAME_FIELD, BOOKS_COUNT_FIELD, POPULARITY_COUNT_FIELD);

    public static final Set<String> LIBRARY_BOOK_FIELDS = Set.of(ID_FIELD, STATUS_FIELD, ADDED_AT_FIELD, RATING_FIELD,
            TITLE_FIELD, PUBLISH_YEAR_FIELD, PAGES_FIELD, LANGUAGE_FIELD,
            CATEGORY_NAME_FIELD);
